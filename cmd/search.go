...
func init() {
	...
	searchCmd.Flags().StringVar(&smallWordLenArg, "smallest-entity", "", output.SearchHelpTexts["smallWord"])
	searchCmd.Flags().StringVar(&bigWordLenArg, "biggest-entity", "", output.SearchHelpTexts["bigWord"])
	searchCmd.Flags().StringVarP(&sizeArg, "size", "s", "", output.SearchHelpTexts["size"])
	searchCmd.Flags().StringVar(&avEntitiesArg, "avg-entity", "", output.SearchHelpTexts["avgEntity"])
	searchCmd.Flags().StringVar(&avEntropyArg, "avg-entropy", "", output.SearchHelpTexts["avgEntropy"])

	searchCmd.Flags().StringVarP(&digitsArg, "digits-perc", "d", "", output.SearchHelpTexts["digitsPerc"])
	searchCmd.Flags().StringVarP(&upperArg, "upper-perc", "u", "", output.SearchHelpTexts["upperPerc"])
	searchCmd.Flags().StringVarP(&spArg, "special-perc", "S", "", output.SearchHelpTexts["specialPerc"])
	searchCmd.Flags().StringVar(&digitsUpperArg, "digits-upper-perc", "", output.SearchHelpTexts["digitsUpperPerc"])
	searchCmd.Flags().StringVar(&digitsSpArg, "digits-special-perc", "", output.SearchHelpTexts["digitsSpecialPerc"])
	searchCmd.Flags().StringVar(&upperSpArg, "upper-special-perc", "", output.SearchHelpTexts["upperSpecialPerc"])
	searchCmd.Flags().StringVar(&digitsUpperSpArg, "all-perc", "", output.SearchHelpTexts["allPerc"])
